...
def generateReport(finalString, modelOutput, path):
    ...
    for line in finalString:
        try:
            ...
            image_path_heat = image_info_heat.split(' ')[1]
...
user_message = "List all IDs with status readyToPaint=false. Talk about relevance of the roughness in yacht painting process while remembering that roughness of at least 2.5 is crucial for good pain adhesion."
